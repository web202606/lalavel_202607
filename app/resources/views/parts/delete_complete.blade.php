...
@extends('base')
@section('head')
<title>{{ config('app.name', '削除完了画面') }}</title>
@endsection
@section('main')
    <main>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-md-8">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-3  text-nowrap">削除完了画面</h1>
                            <p class="lead text-white-50 mb-1 text-nowrap">削除しました</p>
                        </div>
                    </div>
                </div>
            </div>
