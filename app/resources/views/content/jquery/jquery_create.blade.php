...
@extends('base')
@section('head')
<title>{{ config('app.name', 'Jqueryスキル登録画面') }}</title>
@endsection
@section('main')
    <main>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-md-8">
                            <div class="text-center my-5">
                                <h1 class="display-5 fw-bolder text-white mb-3  text-nowrap">Jqueryスキル登録画面</h1>
                                <p class="lead text-white-50 mb-1 text-nowrap">Jqueryスキルを登録してください</p>
        ...
        <div class="card-body d-flex justify-content-center">
            <form action="{{ route('jquerys.store') }}" method="post">
                ...
                <select name='jquery_read' class='form-control'>
                    @if(empty(old('jquery_read'))) or (old('jquery_read') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_read') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_read') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='jquery_structure' class='form-control'>
                    @if(empty(old('jquery_structure'))) or (old('jquery_structure') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_structure') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_structure') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='jquery_method' class='form-control'>
                    @if(empty(old('jquery_method'))) or (old('jquery_method') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_method') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_method') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='jquery_event' class='form-control'>
                    @if(empty(old('jquery_event'))) or (old('jquery_event') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_event') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_event') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='jquery_ajax' class='form-control'>
                     @if(empty(old('jquery_ajax'))) or (old('jquery_ajax') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_ajax') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_ajax') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='jquery_alert' class='form-control'>
                    @if(empty(old('jquery_alert'))) or (old('jquery_alert') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_alert') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_alert') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='jquery_counter' class='form-control'>
                    @if(empty(old('jquery_counter'))) or (old('jquery_counter') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_counter') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_counter') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='jquery_animation' class='form-control'>
                    @if(empty(old('jquery_animation'))) or (old('jquery_animation') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_animation') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_animation') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='jquery_fade' class='form-control'>
                    @if(empty(old('jquery_fade'))) or (old('jquery_fade') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('jquery_fade') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('jquery_fade') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
