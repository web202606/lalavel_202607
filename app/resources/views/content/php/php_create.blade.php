...
@extends('base')
@section('head')
<title>{{ config('app.name', 'PHPスキル登録画面') }}</title>
@endsection
@section('main')
    <main>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-md-8">
                            <div class="text-center my-5">
                                <h1 class="display-5 fw-bolder text-white mb-3  text-nowrap">PHPスキル登録画面</h1>
                                <p class="lead text-white-50 mb-1 text-nowrap">PHPスキルを登録してください</p>
        ...
        <div class="card-body d-flex justify-content-center">
            <form action="{{ route('phps.store') }}" method="post">
                ...
                <select name='php_array' class='form-control'>
                    @if(empty(old('php_array'))) or (old('php_array') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                ...
                <select name='php_for' class='form-control'>
                    @if(empty(old('php_for'))) or (old('php_for') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                ...
                <select name='php_object' class='form-control'>
                    @if(empty(old('php_object'))) or (old('php_object') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                ...
                <select name='php_error' class='form-control'>
                    @if(empty(old('php_error'))) or (old('php_error') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                ...
                <select name='php_get' class='form-control'>
                     @if(empty(old('php_get'))) or (old('php_get') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                ...
                <select name='php_post' class='form-control'>
                    @if(empty(old('php_post'))) or (old('php_post') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                ...
                <select name='php_session' class='form-control'>
                    @if(empty(old('php_session'))) or (old('php_session') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('php_session') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('php_session') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='php_xss' class='form-control'>
                    @if(empty(old('php_xss'))) or (old('php_xss') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                ...
                <select name='php_validation' class='form-control'>
                    @if(empty(old('php_validation'))) or (old('php_validation') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('php_validation') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('php_validation') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
