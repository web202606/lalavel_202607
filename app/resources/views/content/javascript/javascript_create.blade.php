...
@extends('base')
@section('head')
<title>{{ config('app.name', 'Javascriptスキル登録画面') }}</title>
@endsection
@section('main')
    <main>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-md-8">
                            <div class="text-center my-5">
                                <h1 class="display-5 fw-bolder text-white mb-3  text-nowrap">Javascriptスキル登録画面</h1>
                                <p class="lead text-white-50 mb-1 text-nowrap">Javascriptスキルを登録してください</p>
        ...
        <div class="card-body d-flex justify-content-center">
            <form action="{{ route('javascripts.store') }}" method="post">
                ...
                <select name='javascript_file' class='form-control'>
                    @if(empty(old('javascript_file'))) or (old('javascript_file') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_file') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_file') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='javascript_grammar' class='form-control'>
                    @if(empty(old('javascript_grammar'))) or (old('javascript_grammar') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_grammar') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_grammar') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='javascript_variable' class='form-control'>
                    @if(empty(old('javascript_variable'))) or (old('javascript_variable') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_variable') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_variable') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='javascript_data' class='form-control'>
                    @if(empty(old('javascript_data'))) or (old('javascript_data') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_data') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_data') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='javascript_comparison' class='form-control'>
                     @if(empty(old('javascript_comparison'))) or (old('javascript_comparison') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_comparison') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_comparison') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='javascript_logical' class='form-control'>
                    @if(empty(old('javascript_logical'))) or (old('javascript_logical') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_logical') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_logical') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='javascript_dom' class='form-control'>
                    @if(empty(old('javascript_dom'))) or (old('javascript_dom') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_dom') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_dom') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='javascript_structure' class='form-control'>
                    @if(empty(old('javascript_structure'))) or (old('javascript_structure') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_structure') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_structure') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
                ...
                <select name='javascript_method' class='form-control'>
                    @if(empty(old('javascript_method'))) or (old('javascript_method') == 3) 
                        <option value="3" selected>よく理解している</option>
                    @else
                        <option value="3">よく理解している</option>
                    @endif
                    @if(old('javascript_method') == 2) 
                        <option value="2" selected>まずまず理解している</option>
                    @else
                        <option value="2">まずまず理解している</option>
                    @endif                        
                    @if(old('javascript_method') == 1) 
                        <option value="1" selected>理解不足</option>
                    @else
                        <option value="1">理解不足</option>
                    @endif
