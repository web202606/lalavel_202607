@extends('base')
@section('head')
<title>{{ config('app.name', 'DBスキル検索画面') }}</title>
@endsection
@section('main')
    <main>
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-md-8">
                            <div class="text-center my-5">
                                <h1 class="display-5 fw-bolder text-white mb-3  text-nowrap">DBスキル検索画面</h1>
        ...
        <div class="row justify-content-around mt-3 pb-1">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="card-body">
                            <form class="date_option" action="{{ route('database_list') }}" method="GET">
                                @csrf
